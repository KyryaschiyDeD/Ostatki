...
namespace Остатки.Classes
{
	public class Product
	{
		...
		public List<DateTime> DateHistoryRemains { get; set; } // Даты и время проверки остатков
		public List<int> HistoryRemainsWhite { get; set; } // История Остатки из белого списка
		public int RemainsBlack { get; set; } // Остальные остатки
		public List<int> HistoryRemainsBlack { get; set; } // История Остальные остатки
		public double NowPrice { get; set; } // Цена Леруа сейчас
		public List<double> OldPrice { get; set; } // Цена Леруа цена была
		public List<DateTime> DateOldPrice { get; set; }
